...
public class TestWordSpout extends BaseRichSpout {
    ...
    public void nextTuple() {
      ...
      final long msgId1 = ThreadLocalRandom.current().nextLong();
      final long msgId2 = ThreadLocalRandom.current().nextLong();
      collector.emit("s1", v1, msgId1); 
      collector.emit("s2", v2, msgId2); 
      Logger.trace("emit {} {} {}", "s1", v1, msgId1);
      Logger.trace("emit {} {} {}", "s2", v2, msgId2);
    }

    @Override
    public void ack(Object msgId) {
      Logger.trace("ack: {}", msgId.toString());
    }

    @Override
    public void fail(Object msgId) {
      Logger.trace("fail: {}", msgId.toString());
    }
